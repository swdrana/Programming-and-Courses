...
function Students() {
  ...
  return (
    <section className="py-24 lg:pt-[120px] lg:pb-28 bg-[#172227] text-white">
          ...
          <table className="w-full">
            ...
            <tbody>
              {/* <!-- Class & Student List --> */}
              {
                students.map(cls=>{
                    return <>
                        <tr key={cls.class_name} className="bg-white/5">
                    <td className="p-5 text-sm md:text-xl" colSpan="4">
                      {'Class '+_.startCase(cls.class_name)+': '}
                    </td>
                  </tr>
                    {cls.students.map(s=>{
                        return <tr key={s._id} className="border-b border-[#7ECEB529]">
                        <td className="p-5 text-sm md:text-xl">{s.roll}</td>
